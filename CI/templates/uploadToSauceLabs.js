        ...
        fs.readdirSync(dir + appDir).forEach(function(appFile) {
            ...
            if (sauceAppDetails != nil) {
                ...
                if (appFile.includes("ios")) {
                    ...
                    await uploadApplication(sauceAppDetails.iosAPIKey, "MABS 7.0 Pipeline", false, dir + appDir + "/" + appFile)
                    ...
                    await uploadApplication(sauceAppDetails.androidAPIKey, "MABS 7.0 Pipeline", false, dir + appDir + "/" + appFile)
