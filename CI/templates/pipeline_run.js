...
async function executePipeline(appID, plugin, platformVersion, azureProject, pipelineId, token) {
...
var personalToken = process.env.TOKEN;
...
json.forEach(function(run) {
    executePipeline(run.appID, testPipelineArgs.plugin, 10, 'fc594814-b424-4140-ad9f-82e3cb736325', run.platform == 'android' ? testPipelineArgs.androidPipelineID : testPipelineArgs.iosPipelineID, personalToken)
});